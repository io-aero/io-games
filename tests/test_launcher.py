...
# -----------------------------------------------------------------------------
# Test case: version - Show the IO-GAMES version.
# -----------------------------------------------------------------------------
def test_launcher_version() -> None:
    ...
    commands = {
        "Darwin": ["./run_io_games_pytest.zsh", "version"],
        "Linux": ["./run_io_games_pytest.sh", "version"],
        "Windows": ["cmd.exe", "/c", "run_io_games_pytest.bat", "version"],
    }
